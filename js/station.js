// Objet pour carte 
var Maps = {
    iconBase : "images/marqueur.png", // Icône de marqueur par défaut
    tableauMarqueur : [], // Tableau où sera inséré les différents marqueurs, cela servira à les rassembler (marker Clusterer)
    
     // Attribue une image au marqueur pour les stations ouverte et fermer
    iconMarqueur : function(statusStation) {
        if(statusStation === "OPEN") {
            this.iconBase = "images/marqueur_vert.png"; // Stations Ouvertes 
        } else if(statusStation === "CLOSED") {
            this.iconBase = "images/marqueur_rouge.png"; // Stations Fermer 
        }
    },
     // Insert les marqueurs sur la carte 
    initMarqueur : function(positionStation) {
        ...
        this.tableauMarqueur.push(marqueur); // Ajoute les marqueurs dans un tableau qui sera utilisé par "markerClusterer"
    },
     // Méthode pour le regroupement des marqueurs
    regroupementMarqueurs : function() {
        marqueurCluster = new MarkerClusterer(map, this.tableauMarqueur,
        {
            imagePath : "images/m", // Icônes du markerClusterer
        });
    },
...
var Station = {
    ...
    autorisation : null, // Propriété d'autorisation de réservation
     // Méthode Ajax qui permettra de récupérer la liste des stations Vélo'
    ajaxGet : function(url, callback) {
     ...
     // Remplit les attributs de données de la station
    traitementDonneesStation : function(donneesStation) {
     ...
     // Insert les données dans la page
...
Station.ajaxGet("https://api.jcdecaux.com/vls/v1/stations?contract=rouen&apiKey=d6a88b7b9237662fad240b1b88ceb8a7454dba06", function(reponse) {
